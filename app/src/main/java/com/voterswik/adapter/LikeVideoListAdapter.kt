...
import com.voterswik.databinding.RowLikeVideoListBinding
import com.voterswik.ui.BaseModel
import com.voterswik.utils.OnItemClickListener

class LikeVideoListAdapter<T : BaseModel> internal constructor(
    private val videoList: List<BaseModel>, val onItemClickListener: OnItemClickListener<T>
) : RecyclerView.Adapter<LikeVideoListAdapter.AgentViewHolder>() {
    ...
    class AgentViewHolder(val binding: RowLikeVideoListBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): AgentViewHolder {
                ...
                val binding: RowLikeVideoListBinding = DataBindingUtil
                    .inflate(
                        layoutInflater, R.layout.row_like_video_list,
                        parent, false
                    )
