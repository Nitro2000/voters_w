...
import com.voterswik.databinding.RowMusicListBinding
import com.voterswik.ui.BaseModel
import com.voterswik.utils.OnItemClickListener

class MusicAdapter<T : BaseModel> internal constructor(
    val musicList: List<BaseModel>, val onItemClickListener: OnItemClickListener<T>,
) : RecyclerView.Adapter<MusicAdapter.AgentViewHolder>() {
    ...
    class AgentViewHolder(val binding: RowMusicListBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): AgentViewHolder {
                ...
                val binding: RowMusicListBinding = DataBindingUtil
                    .inflate(
                        layoutInflater, R.layout.row_music_list,
                        parent, false
                    )
